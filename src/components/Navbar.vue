<template>
  <header class="bg-gradient-to-r from-purple-500 to-indigo-500 shadow-lg p-7 flex justify-between sticky top-0">
    <h3 class="font-mono text-xl font-extrabold text-purple-100 cursor-pointer" @click = "homeRouting">
      webSolutions
    </h3>
  ...
  <div
    ...
    v-show="showDropdown"
  >
    <div class = "text-white block p-10 hover:bg-gray-700 cursor-pointer" v-if = "!User" @click = "signUphandler"><i class="fab fa-google"></i></div>
    <div class = "text-white block p-10 hover:bg-gray-700 cursor-pointer" v-if = "User" @click = "clickHandler">Logout</div>
