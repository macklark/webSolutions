<template>
    ...
    <div class="container mx-auto flex justify-center">
        <div class="p-60 md:w-full pt-10 mx-auto pb-20">
            <form @submit.prevent="submitHandler">
                ...
                >
                <input
                    class="block mb-10 h-8 w-full border-2 outline-none p-5"
                    v-model="title"
                    type="text"
                    required
                    spellcheck="false"
                ...
                >
                <textarea
                    class="block mb-10 w-full border-2 outline-none p-2 h-32"
                    v-model="description"
                    required
                    spellcheck="false"
                ></textarea>
                ...
                <div class="flex flex-wrap">
                    <div
                        class="px-6 py-3 m-2 bg-purple-200 border-purple-400 border-2 rounded-full inline"
                        v-for="tag in tags"
                        :key="tag"
                    >
                        {{ tag }}
                ...
                <div class="md:text-center">
                    ...
                    <button
                        class="bg-red-500 px-6 ml-5 py-2 rounded shadow-inner text-white opacity-100 hover:bg-red-400 transition ease-in-out duration-500 mt-10 text-2xl"
